            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="card-title">
                        <span class="font-weight-bold text-lg text-dark">{{trans('common.add_member_label')}}</span>
                    </div>
                </div>
                <form method="POST" id="form" action="{{ route('members.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input id="first_name"  name="first_name" class="form-control" placeholder="Enter first name" type="text" />
                                    @error('first_name')
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input id="last_name" name="last_name" class="form-control" placeholder="Enter last name" type="text" />
                                    @error('last_name')
                                    <small id="nameError" class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control" placeholder="{{trans('common.address_placeholder_label')}}">
                                    @error('address')
                                    <small id="nameError" class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="neighborhood" id="neighborhood" class="form-control" placeholder="{{trans('common.address_placeholder_label')}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="phone_number" name="phone_number" class="form-control" placeholder="+597">
                                    </div>
                                    @error('phone_number')
                                    <small id="nameError" class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="id_number" name="id_number" placeholder="email@gmail.com" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="job_description" name="job_description" class="form-control" placeholder="{{trans('common.job_description_label')}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="row">
                                ...
                                <div class="form-row mt-2">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea id="skills" name="skills" type="text" class="form-control" rows="4" placeholder="{{trans('common.skills_placeholder_label')}}"></textarea>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="notes" class="font-weight-bold text-dark">{{trans('common.notes_label')}}</label>
                                            <textarea id="notes" name="notes" type="text" class="form-control" rows="4" placeholder="{{trans('common.notes_placeholder_label')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 d-flex justify-content-center align-items-center">
                                <div class="">
                                    <img src="" alt="user_image" id="preview_image" class="d-none rounded" width="140" height="170">
                                </div>
                            </div>
                        </div>
