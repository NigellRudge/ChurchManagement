...
@section('content')
    <div class="container justify-content-center">
        <div class="row">
            <div class="col-10">
                <form method="POST" action="{{ route('tides.update',['tide'=>$data['tide']])}}">
                    @csrf
                    @method('PATCH')
                    <div class="card ">
                        <div class="card-header">
                            <div class="">
                                <span class="card-title font-weight-bold">Edit Tide</span>
                            </div>
                        </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="member_id"  id="member_id" type="text" class="form-control">
                                        </select>
                                        @error('member')
                            ...
                            <div class="form-row">
                                        ...
                                        <select name="currency_id" id="currency_id" data-placeholder="Select currency" class="form-control">
                                            @foreach($data['currencies'] as $currency)
                                                <option value="{{$currency->id}}"
                                                    @if($data['tide']['currency_id'] == $currency->id)
                                                        selected
                                                    @endif
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input name="amount" id="amount" placeholder="$0.00" value="{{$data['tide']['amount']}}" type="number" class="form-control" />
                                        @error('amount')
