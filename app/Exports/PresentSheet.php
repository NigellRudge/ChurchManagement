...
class PresentSheet implements FromQuery, WithTitle, WithCustomStartCell, WithEvents
{
    private $title;
    private $sheet_id;
    private $startRow = 6;
    ...
    {
        $this->itemCount = RollCall::query()->where('sheet_id',$this->sheet_id)
            ->count() + 1;
        return RollCall::query()->where('sheet_id',$this->sheet_id)
            ->select('id','member','group','phone_number');
    }
